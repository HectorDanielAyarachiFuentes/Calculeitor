var w;
	...
	function alCargar(){
		...
		if (idioma==2) {
			document.getElementsByTagName("header")[0].innerHTML="<span><p>ALICE</span>'S CALCULATOR</p><p id='ptwitter' style='font-family:kurzetstypekurzetstype;font-Size:0.3em;'><a id='atwitter' href='' target='_blank'></a></p>";
			...
			document.getElementsByTagName("header")[0].innerHTML="<p>LA CALCULADORA D'<span>ALÍCIA</span></p><p id='ptwitter' style='font-family:kurzetstypekurzetstype;font-Size:0.3em;'><a id='atwitter' href='' target='_blank'></a></p>";
			...
			document.getElementsByTagName("header")[0].innerHTML="<p>✨ La Super Calculadora de <span>Facundo</span> ✨</p><p id='ptwitter' style='font-family:kurzetstypekurzetstype;font-Size:0.3em;'><a id='atwitter' href='' target='_blank'>Hecha con ❤️</a></p>";
